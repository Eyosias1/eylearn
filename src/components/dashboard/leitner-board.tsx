...
import { LeitnerBoxDialog } from "@/components/dashboard/leitner-box-dialog"
...
export function LeitnerBoard({ cards }: Props) {
  ...
  return (
        ...
        return (
          <div
            ...
            className={cn(
              ...
              // mastered box
              box === 5 && "border-emerald-500/30 bg-emerald-500/5 hover:bg-emerald-500/10",
            )}
          >
    ...
    <LeitnerBoxDialog box={selectedBox} cards={cards} onClose={() => setSelectedBox(null)} />
    </>
  )
}
