...
import { SubtopicRow } from "@/components/subtopics/subtopic-row"
        ...
        {expanded && (
          <div className={cn(
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs text-muted-foreground hover:text-foreground transition-colors w-fit"
            >
